        ...
        <form onSubmit={handleSubmit(onAdd)}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input {...register('startYear')} type="number" placeholder="2018" className={inputCls} />
            </div>
            <div>
              <label className="text-xs font-medium text-ink-600 mb-1.5 block">Tugash yili</label>
              <input {...register('endYear')} type="number" placeholder="2022" className={inputCls} />
            </div>
          </div>
